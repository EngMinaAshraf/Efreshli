...
interface Product {
  ...
  size: string;
  imageUrl: string;
  isInWishlist?: boolean; // إضافة خاصية لتتبع الوضع في Wishlist
}
...
export class ProductListComponent implements OnInit {
  ...
  myFavorites: Product[] = []; // قائمة My Favorites
  wishlistLists: Wishlist[] = [{ name: 'My Favorites', products: [] }]; // قوائم الـ Wishlist
  showWishlistDropdown: boolean = false; // للتحكم في عرض القائمة المنسدلة
  selectedProduct: Product | null = null; // المنتج المختار لإضافته
